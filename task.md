...
The user can specify a location or preferred distance for matches.
...
The backend is implemented using primary language from Coding Fundamentals.

The frontend is implemented in React using Typescript.
